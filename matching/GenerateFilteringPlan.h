...
public:
    ...
    static void generateCECIFilterPlan(const Graph *data_graph, const Graph *query_graph, TreeNode *&tree,
                                       VertexID *&order);
    static void generateVSSimFilterPlan(const Graph *data_graph, const Graph *query_graph, TreeNode *&tree,
                                        VertexID *&order);
private:
    ...
    static VertexID selectVSSimStartVertex(const Graph *data_graph, const Graph *query_graph, ui *score);
};
